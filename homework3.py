...
def train():
    ...
    agent = Agent(baseline_discount=0.9, normalize_advantages=True)
    num_episodes = 20000
...
def test(model_path="model.pt", num_episodes=10, render=True):
    ...
    for i in range(num_episodes):
        ...
        test_rewards.append(cumulative_reward)
        print(f"Test Episode {i}, Reward: {cumulative_reward:.2f}, Steps: {episode_steps}")
